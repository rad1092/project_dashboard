...
FLOW_STEPS = [
    ...
    },
    {
        ...
        "status": "현재 구현",
        "now_note": "현재는 과거 전처리 데이터 안에서만 최근 이력을 찾는다.",
        "future_note": "실시간 특보 API 는 준비 페이지와 docs 에서만 미리 정리한다.",
    },
    {
        "step": "03",
        "title": "재난 그룹 정규화",
        "summary": "원본 특보 명칭을 내부 재난 그룹으로 묶어 어떤 후보를 먼저 볼지 정한다.",
        "status": "현재 구현",
        "now_note": "강풍/풍랑, 호우/태풍처럼 비슷한 상황을 같은 그룹으로 관리한다.",
    ...
    },
    {
        ...
        "status": "현재 구현",
        "now_note": "전용, 기본, 대체 대피소를 다른 라벨로 구분한다.",
        "future_note": "재난별 세부 정책은 후보 필터 기준만 교체하면 된다.",
    },
    {
        "step": "05",
        "title": "거리 정렬과 지도 표시",
        "summary": "직선 거리 기준으로 Top 3 를 정렬하고 무료 OSM 지도에 선과 점으로 표시한다.",
        "status": "현재 구현",
        "now_note": "실제 도로 경로나 이동 시간은 제공하지 않는다.",
